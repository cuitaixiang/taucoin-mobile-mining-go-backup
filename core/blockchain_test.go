...
func newCanonical(engine consensus.Engine, n int, full bool) (taudb.Database, *BlockChain, error) {
	...
	blockchain, _ := NewBlockChain(db, nil, params.AllTauashProtocolChanges, engine, nil)
...
func testReorgBadHashes(t *testing.T, full bool) {
	...
	ncm, err := NewBlockChain(blockchain.db, nil, blockchain.chainConfig, tauhash.NewFaker(), nil)
	if err != nil {
...
func TestFastVsFullChains(t *testing.T) {
	...
	archive, _ := NewBlockChain(archiveDb, nil, gspec.Config, tauhash.NewFaker(), nil)
	defer archive.Stop()
	...
	fast, _ := NewBlockChain(fastDb, nil, gspec.Config, tauhash.NewFaker(), nil)
	defer fast.Stop()
	...
	ancient, _ := NewBlockChain(ancientDb, nil, gspec.Config, tauhash.NewFaker(), nil)
	defer ancient.Stop()
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	defer delfn()
	light, _ := NewBlockChain(lightDb, nil, gspec.Config, tauhash.NewFaker(), nil)
...
func TestChainTxReorgs(t *testing.T) {
	...
	blockchain, _ := NewBlockChain(db, nil, gspec.Config, tauhash.NewFaker(), nil)
...
func TestBlockchainHeaderchainReorgConsistency(t *testing.T) {
	...
	chain, err := NewBlockChain(diskdb, nil, params.TestChainConfig, engine, nil)
	if err != nil {
...
func testInsertKnownChainData(t *testing.T, typ string) {
	...
	chain, err := NewBlockChain(chaindb, nil, params.TestChainConfig, engine, nil)
	if err != nil {
		t.Fatalf("failed to create tester chain: %v", err)
	}
